      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        ...
        <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
          ...
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/restaurant-app-107ae.appspot.com/o/Images%2F1731650698794-i6.png?alt=media&token=0fe9f0e9-864e-420b-8263-c7e96a295eb7"
              alt=""
            />
            {/* name Section */}
        ...
        <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
          ...
          <motion.button
            whileTap={{ scale: 0.75 }}
            type="button"
            className="w-full p-2 rounded-full bg-gradient-to-tr from-orange-400 to-orange-600 text-gray-50 text-lg my-2 hover:shadow-lg translate-all duration-150 ease-out"
          >
            Check Out
          </motion.button>
        </div>
